...
class App():
	...
	def __init__(self, master):
		...
		self.frame_json_btn = Button(self.frame, text="To Lightbars", command=send_to_lightbars)		
	...
	def display_current_frame(self):
		for y in range(self.frame_rows):
			for x in range(self.frame_columns):
				...
				canvas = Canvas(self.frame_section,background=self.current_frame[y][x], name="displayCanvas"+str(y)+str(x),width=50, height=50)
