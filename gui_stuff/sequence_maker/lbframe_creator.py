...
def save_sequence():
	fps = int(app.fps_entry.get())
	sequence_num = int(app.sequence_num_entry.get())
	loops = int(app.loops_entry.get())
	message = app.sequence_to_json(fps, loops, sequence_num)
...
class App():
	...
	def __init__(self, master):
		...
		self.frame_json_btn = Button(self.frame, text="Save Frame", command=save_frame)		
		...
		self.send_sequence_btn = Button(self.frame, text="Save Sequence", command=save_sequence)
		...
		self.loops_label = Label(self.frame, text="loops")
		self.loops_label.grid(row=2, column=0)
		self.loops_entry = Entry(self.frame)
		self.loops_entry.insert(0, "0")
		self.loops_entry.grid(row=2, column=1)	

		self.sequence_num_label = Label(self.frame, text="sequence num")
		self.sequence_num_label.grid(row=2, column=2)
		self.sequence_num_entry = Entry(self.frame)
		self.sequence_num_entry.insert(0, "0")
		self.sequence_num_entry.grid(row=2, column=3)
		
		self.fps_label = Label(self.frame, text="fps")
		self.fps_label.grid(row=2, column=4)
		self.fps_entry = Entry(self.frame)
		self.fps_entry.insert(0, "0")
		self.fps_entry.grid(row=2, column=5)
